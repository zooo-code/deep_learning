...
path_dir1 = './3/3true_total/'
path_dir2 = './3/3false_total/'
...
history = model.fit(train_img, train_label, epochs=10, batch_size=50, validation_data=(test_img, test_label))

# save model
model.save("stage3_total.h5")
